        ...
        <div className="flex flex-col items-center w-full p-6 sm:p-12  ">
          <div className="w-full max-w-md ">
            ...
            <div className="flex flex-col items-center gap-2 ">
              ...
              <p className="text-s text-slate-400 ">Login to Admin account</p>
            </div>
            ...
            <div className="flex flex-col items-center py-6 ">
              <form onSubmit={handleLogin} className="w-full ">
                ...
                <button
                  type="submit"
                  className=" w-full text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br  focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2 mt-2  transition-all"
                >
                  Login
                </button>
              </form>
